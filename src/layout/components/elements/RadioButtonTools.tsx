import { type RadioButtonComponent } from '@/modules/area_job/models/Components'

interface Props {
  component: RadioButtonComponent
  setComponent: (comp: RadioButtonComponent) => void
}

export default function RadioButtonTools({ component, setComponent }: Props) {
  return (
